...
from review_coach.skills.black_myth_wukong import BlackMythWukongReviewSkill
...
from review_coach.skills.street_fighter6 import StreetFighter6ReviewSkill
...
class ReviewCoach:
    def __init__(self, gemini_client: GeminiClient | None = None):
        ...
        self.skills: dict[str, BaseGameSkill] = {
            ...
            "street_fighter6": StreetFighter6ReviewSkill(),
            "sf6": StreetFighter6ReviewSkill(),
            "fighting": StreetFighter6ReviewSkill(),
            "black_myth_wukong": BlackMythWukongReviewSkill(),
            "black_myth": BlackMythWukongReviewSkill(),
            "wukong": BlackMythWukongReviewSkill(),
            "action_rpg": BlackMythWukongReviewSkill(),
